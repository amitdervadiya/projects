        ...
        <div className="mini h-full w-[65%] border flex justify-center">
          <div className="sidebar h-full w-[20%] border pt-3 overflow-y-scroll bg-slate-100">
            {sidebar.map((item, index) => (
              <div
                key={item.name || index}
                className={`card-side h-[70px] w-full flex items-center p-2 overflow-hidden ${selectedIndex === index ? "bg-green-100" : "bg-white"
                  }`}
              ...
              {status === "succeeded" &&
                fetchapi.map((item, index) => (
                  item.category === "milk" && (
                    <div
                      key={index}
                      className="item-card my-2 border-[#e8e8e8] h-min flex flex-col justify-between items-center p-2 border bg-white rounded-xl md:w-[49%] lg:w-[23%]"
                    >
                      <div className="imgs h-[130px] w-full">
                      ...
                      <div className="product flex justify-between flex-col items-start px-3 py-2 h-[120px]">
                        <div className="flex justify-center items-center bg-[#f8f8f8]">
                          ...
                          />
                          <span className="text-xs font-bold">11 mins</span>
                        </div>
                        ...
                        <div className="product-price flex justify-between w-full items-center">
                          ...
                          {isAddedArray[index] ? (
                            <div className="flex items-center  bg-[#318616] px-2 py-1 gap-1  rounded-md">
                              <button
                                className="text-white border border-[#318616] px-1  rounded-md text-sm"
                              ...
                              <button
                                className="border text-white border-[#318616] px-1 rounded-md text-sm"
                            ...
                            <button
                              className="text-[#318616] border border-[#318616] px-5 py-2 rounded-md text-sm"
