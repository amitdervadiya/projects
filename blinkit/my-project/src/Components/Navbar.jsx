...
import { BiSearch, BiSolidCart, BiSolidCartAlt } from 'react-icons/bi'
      ...
      <nav className='h-[86px] w-[100%] flex lg:justify-center items-center  px-5 '>
        <div className="logo h-[86px] flex justify-center items-center w-[8%]">
          <svg width="134" height="30" viewBox="0 0 114 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M90.2609 0.00241089H97.4307V5.59215H90.2609V0.00241089Z" fill="#54B226"></path></svg>
        </div>
        ...
        <div className='search-bar h-[86px] w-[70%] md:w-[60%] flex justify-center items-center '>
          <div className='serch h-[48px] px-3 w-[100%] bg-[#f8f8f8] rounded-md flex justify-center items-center'>

            <div className="icon text-2xl">
              <BiSearch />
            </div>
            <input type="text" className='h-[46px] w-[100%] bg-none bg-transparent outline-none border-none px-2' />
          </div>
        </div>

        <div className="login h-[86px] w-[162px] flex justify-center md:w-[120px] items-center">
          <span className='text-[#363636] text-[18px]'>Login</span>
        </div>
        <div className='cart h-[86px] w-[112px] flex justify-center items-center'>
          <div className="CART bg-[#0C831f] h-[52px]  w-[112px] flex  items-center rounded-xl justify-evenly">
